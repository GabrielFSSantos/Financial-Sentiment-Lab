...
from pipeline.common import column_series, numeric_series
...
def build_news_impact_frame(
    ...
    *,
    ...
    for key in DIMENSION_KEYS:
        ...
        frame[short] = _extract_dimension_series(
            frame,
            key=key,
    ...
    for (company, sector), group in daily_impact.groupby(
        ...
        for current_date in dates:
            ...
            if timestamp in impact_by_date:
                ...
                risco_dia = 0.0
                news_count = 0
                iti_liquido = alpha * iti_liquido
                iti_risco = alpha * iti_risco
