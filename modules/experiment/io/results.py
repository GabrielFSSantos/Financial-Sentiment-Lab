...
class ResultsManager:
    ...
    def index_paths(
        ...
        return IndexOutputPaths(
            ...
            baselines_daily=root / "baselines_daily.csv",
        )
    ...
    def save_temporal_index(
        ...
        if artifacts.baselines_daily is not None and not artifacts.baselines_daily.empty:
            self._write_csv(paths.baselines_daily, artifacts.baselines_daily)
            outputs["baselines_daily"] = str(paths.baselines_daily)
            self._register_file(combination, "baselines_daily.csv", paths.baselines_daily)
