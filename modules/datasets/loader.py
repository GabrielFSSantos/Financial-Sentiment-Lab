...
from modules.datasets.common import ASSET_FETCH_HINT, CANONICAL_LABELS
...
def validate_dataset(
    ...
    """Valida formato e colunas mapeadas sem carregar todas as linhas."""

    loader = DatasetLoader()
    loader.validate_file(configuration)
    columns = loader.inspect_columns(configuration)
    return {
        "dataset_key": configuration.key,
        "dataset_name": configuration.dataset_name,
        "path": str(configuration.path) if configuration.path else None,
